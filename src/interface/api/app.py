...
def create_app(fup_service: FupService, admin_service: AdminService, billing_service: BillingService) -> FastAPI:
    ...
    app = FastAPI(
        ...
        version="1.2.0",
        description="Backend API for MikroTik FUP & Billing Dashboard",
    ...
    # Include Routes
    router = create_router(fup_service, admin_service, billing_service)
