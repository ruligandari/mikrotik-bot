...
class TelegramBotInterface:
    ...
    async def cmd_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        help_text = (
            ...
            "• /sessions - Daftar user online\n"
            "• /summary - Ringkasan traffic\n"
            "• /top - Top usage bulan ini\n"
            "• /throttled - Lihat user yg kena limit\n"
            "• /logs <u|limit> - Riwayat FUP\n\n"
            "⚙️ *Admin Tool*\n"
            "• /add_user <u|p|prof> - Tambah PPPoE\n"
            "• /wa <u|number> - Set WhatsApp\n"
            "• /del_user <u> - Hapus PPPoE\n"
            "• /kick <u> - Putus sesi aktif\n"
            "• /set_limit <u|gb> - Set Limit Khusus\n"
            "• /set_enabled <u|1/0> - On/Off Auto-FUP\n"
            "• /force_throttle <u|msg> - Limit Paksa\n"
            "• /force_normal <u|msg> - Normal Paksa\n"
            "• /runcheck - Cek FUP Manual\n"
            "• /chatid - Info Chat ID\n"
